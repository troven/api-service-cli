...
export default class LocalDBPlugin extends AbstractDataStore {
  ...
  create(
    ...
    let collection_name = Vars.$(
      all_options[this.getCollectionField()],
      crud_options
    );
    let db = new PouchDB(database + "_" + collection_name);

    this.context.log({
      code: "plugin:crud:localdb:create",
      database: database,
  ...
  update(
    ...
    this.context.log({
      code: "plugin:crud:localdb:update",
      database: database,
      collection: collection_name,
      options: crud_options,
      filter: meta,
  ...
  delete(
    ...
    this.context.log({
      code: "plugin:crud:localdb:delete",
      database: database,
      collection: collection_name,
      options: crud_options,
      filter: meta,
